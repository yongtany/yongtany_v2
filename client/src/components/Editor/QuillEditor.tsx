...
class Clipboard extends QuillClipboard {
    ...
    getMetaTagElements = (stringContent: any) => {
...
class VideoBlot extends BlockEmbed {
    ...
    static create(value: any) {
        if (value && value.src) {
            ...
            const iframeTag: any = document.createElement('iframe');
...
class QuillEditor extends React.Component<Props, State> {
    ...
    _isMounted :any;
    reactQuillRef: any;
    inputOpenImageRef: any;
    inputOpenFileRef: any;
    inputOpenVideoRef: any;
